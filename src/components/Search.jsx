...
const Search = () => {
    const { data: search, isLoading, error } = useGetSearchQuery(); // Destructuring needed properties from Endpoint
    ...
    const { results } = search; // Destructuring results from the general search data object

    return ( 
        <div className="container py-5 dark:bg-gdark-300 dark:text-gdark-50">
